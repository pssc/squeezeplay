...
function _process_displaystatus(self, event)
	...
	if data.display then
		...
		elseif type == 'mixed' or type == 'popupalbum' then
			...
			self.slimServer:fetchArtwork(display["icon-id"] or display["icon"], s.artIcon, jiveMain:getSkinParamOrNil('POPUP_THUMB_SIZE') or jiveMain:getSkinParam('THUMB_SIZE'))
