...
typedef enum {
	...
	JIVE_EVENT_KEY_LONGHOLD		= 0x00000060,
	...
	JIVE_EVENT_KEY_ALL		= ( JIVE_EVENT_KEY_DOWN | JIVE_EVENT_KEY_UP | JIVE_EVENT_KEY_PRESS | JIVE_EVENT_KEY_HOLD |JIVE_EVENT_KEY_LONGHOLD ),
